...
FROM
  (
    SELECT
      TO_JSON(m) AS module,
      JSON_AGG(JSON_BUILD_OBJECT('id',sp.id,'teachingUnit',sp.teaching_unit,'mandatory',msp.mandatory,'focus',msp.focus)) AS study_programs
    FROM
      module AS m
...
INSERT INTO semester_plan_type VALUES
(
  'exam',
  'Prüfungszeitraum',
  'Exam period'
